...
public class StringToInt extends TranslatorBlock
{
	public StringToInt(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
