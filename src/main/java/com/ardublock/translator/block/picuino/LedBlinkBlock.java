...
public class LedBlinkBlock extends TranslatorBlock {

	public LedBlinkBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
		...
		String timeOn = translatorBlock.toCode();
		translatorBlock = this.getRequiredTranslatorBlockAtSocket(2);
		String timeOff = translatorBlock.toCode();
