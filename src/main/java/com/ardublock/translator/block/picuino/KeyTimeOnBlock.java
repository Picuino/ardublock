...
public class KeyTimeOnBlock extends TranslatorBlock {

	public KeyTimeOnBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
