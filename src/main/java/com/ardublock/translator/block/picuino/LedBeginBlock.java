...
public class LedBeginBlock extends TranslatorBlock {

	public LedBeginBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
