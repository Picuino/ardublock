...
public class KeyBeginBlock extends TranslatorBlock {

	public KeyBeginBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
