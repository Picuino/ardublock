...
public class BuzzPlayLenBlock extends TranslatorBlock {

	public BuzzPlayLenBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
