...
public class DispBeginBlock extends TranslatorBlock {

	public DispBeginBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
