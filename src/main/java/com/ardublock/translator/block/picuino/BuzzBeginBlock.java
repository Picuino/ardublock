...
public class BuzzBeginBlock extends TranslatorBlock {

	public BuzzBeginBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
