...
public class DispNumBlock extends TranslatorBlock {

	public DispNumBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
