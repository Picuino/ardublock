...
public class MeIRControl extends TranslatorBlock {

	public MeIRControl(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
